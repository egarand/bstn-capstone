...
function ContributePage() {
	...
	<section className="contribute__intro">
		...
		<p className="contribute__intro-body">Hike & Seek is powered by open source databases. These incredible projects thrive on community support and contributions — so while you&apos;re off adventuring, why not dive in and lend a hand?</p>
	</section>
